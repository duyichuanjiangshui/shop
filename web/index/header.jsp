		...
		<div class="container">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					...
					<h1 class="navbar-brand" style="font-size:28px; margin-top:8px;"><a href="index">网上商城系统</a></h1>
				</div>
				<!--navbar-header-->
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li><a href="top?typeid=2" <c:if test="${flag==7}">class="active"</c:if>>热门</a></li>
						<li><a href="top?typeid=3" <c:if test="${flag==8}">class="active"</c:if>>性价比</a></li>
						...
						<!-- <li><a href="../admin.jsp" target="_blank">后台登录</a></li> -->
			...
			<div class="header-info">
				...
				<div class="header-right cart">
					<a href="cart">
						<span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"><span class="card_num" style="font-size:15px;">${order.amount==null ? '' :order.amount}</span></span>
					</a>
				</div>
				<div class="header-right login">
					<a href="my"><span class="glyphicon glyphicon-user"  aria-hidden="true"><span style="font-size:15px;">${sessionScope.user.username}</span></span></a>
				</div>
