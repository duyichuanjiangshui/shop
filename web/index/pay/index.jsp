...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" type="submit"
								style="text-align: center; width:200px;">付 款</button>
			...
			<div id="body2" class="tab-content" name="divcontent">
				<dl class="content">
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" type="submit"
								style="text-align: center; width:200px;">交 易 查 询</button>
			...
			<div id="body3" class="tab-content" name="divcontent">
				<dl class="content">
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" type="submit"
								style="text-align: center; width:200px;">退 款</button>
			...
			<div id="body4" class="tab-content" name="divcontent">
				<dl class="content">
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" type="submit"
								style="text-align: center; width:200px;" >退 款 查 询</button>
		...
		<form name=tradeclose action="close" method=post
			...
			<div id="body5" class="tab-content" name="divcontent">
				<dl class="content">
					...
					<dt></dt>
					<dd id="btn-dd">
						<span class="new-btn-login-sp" style="width:200px;">
							<button class="new-btn-login" type="submit"
		...
		<div id="foot">
			<ul class="foot-ul">
				<li>支付宝版权所有 2015-2020 ALIPAY.COM</li>
			</ul>
		</div>
	</div>
</body>
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = ${order.id} ;
		document.getElementById("WIDtotal_amount").value = ${order.total};
	}
	GetDateNow();
</script>
</html>